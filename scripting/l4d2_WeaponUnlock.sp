...
public OnPluginStart()
{
	...
	h_AWPEnabled = CreateConVar("l4d2_wu_awp", "0", "Enable AWP sniper rifle?", FCVAR_PLUGIN)
	h_MP5Enabled = CreateConVar("l4d2_wu_mp5", "0", "Enable MP5 submachine gun?", FCVAR_PLUGIN)
	h_ScoutEnabled = CreateConVar("l4d2_wu_scout", "0", "Enable Scout sniper rifle?", FCVAR_PLUGIN)
	h_SG552Enabled = CreateConVar("l4d2_wu_sg552", "0", "Enable SG552 assault rifle?", FCVAR_PLUGIN)
	h_AWPBoost = CreateConVar("l4d2_wu_awpboost", "135", "Amount of damage added to AWP sniper rifle, base 115.", FCVAR_PLUGIN)
	h_ScoutBoost = CreateConVar("l4d2_wu_scoutboost", "110", "Amount of damage added to scout sniper rifle, base 90.", FCVAR_PLUGIN)
	h_SG552Boost = CreateConVar("l4d2_wu_sg552boost", "5", "Amount of damage added to SG552, base 32.", FCVAR_PLUGIN)
	h_MP5Boost = CreateConVar("l4d2_wu_mp5boost", "0", "Amount of damage added to MP5, base 22.", FCVAR_PLUGIN)
